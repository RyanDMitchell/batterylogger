 ...
 * @author Ryan
 */
public class ResistanceChartForm{
    private Battery battery;
        
    public ResistanceChartForm(Battery battery,Batteries batteries){
    ...
    private void initAndShowGUI() {
        ...
        JFrame frame = new JFrame("Battery Resistance");
    ...
    private Scene createScene() {
        ...
        lineChart.setTitle("Battery Internal Resistance");
        ...
        for(int i = 0;i<battery.getChargeCount();i++){
             ...
             if(tempCharge.isServiceCharge()){
                ...
                series.getData().add(new XYChart.Data(diff, tempCharge.getResistance()));
             }
        }
